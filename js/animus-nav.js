...
(function (g) {
  ...
  function ac(active, key) {
    ...
    if (key === 'activity' && (active === 'friends' || active === 'notifications')) return ' active';
    return '';
  }
  ...
  function buildNavbar(active) {
    ...
    return (
      ...
      '<a href="/activity" class="nav-item nav-item-notif' +
      ac(active, 'activity') +
      '" id="navNotifBtn">' +
      SVG_ACTIVITY +
      ...
      '">' +
      SVG_SHOP +
      ' <span data-en="Shop" data-es="Tienda">Shop</span></a>' +
      ...
      ac(active, 'compare') +
      '">Compare</a>' +
      '<a href="/shop" class="nav-mobile-item' +
      ac(active, 'shop') +
      '">Shop</a>' +
  ...
  function buildBottomNav(active) {
    ...
    return (
      ...
      svgHome +
      '<span data-en="Home" data-es="Inicio">Home</span></a>' +
      '<a href="/activity" class="mbn-item' +
      ac(active, 'activity') +
      '">' +
      svgActivity +
      ...
      '">' +
      svgTest +
      '<span data-en="Test" data-es="Test">Test</span></a>' +
      '<a href="/shop" class="mbn-item' +
      ac(active, 'shop') +
      '">' +
      svgShop +
      '<span data-en="Shop" data-es="Tienda">Shop</span></a>' +
